...
// Rota para buscar todas as previsões de desrama por ano
router.get("/desramas/previsoes/ano/:ano", (req, res) => {
  ...
  // e junta com a tabela de imóveis para obter os detalhes do imóvel
  const sql = `
    SELECT 
      d.id as previsao_id,
      d.previsao,
